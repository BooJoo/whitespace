...
public class ProxyClient implements DataListener {
	...
	for (int i=0; i < dataObject.size(); i++) {
	    ...
	    for (Trigger t : listeners.get(dataElement.getName())) {
		t.trigger(dataElement);
	    }
	}
    }
	...
	public void trigger (DataElement dataElement) {
	    
	}
	
	@Override
	public boolean equals (Object o) {
	    return (o instanceof Trigger) && ((Trigger) o).equals(this);
	}
    }
}
